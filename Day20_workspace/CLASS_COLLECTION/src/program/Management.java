...
public class Management {
	...
	public static void main(String[] args) {
		...
		//   생략해서 작성했음을 알기 위해 -> 를 통해 람다식이라는 것을 구별함
		// - 실행코드는 동일하게 작성하여 사용함
		
		// 람다식의 특징
		// - 반환값의 종류는 재정의할 메서드에 의해서 강제로 정해짐
		//   재정의하는 메서드에 대해서 파악하고 있어야 함
		// - 중괄호가 있을 경우에는 코드를 작성해서 return처리가 됨
		//   중괄호가 없을 경우, return처리가 자동으로 붙는다.
		...
		Comparator<Variables> comp1 =
					(Variables that1, Variables that2) -> that1.get2() - that2.get2();
					/*
					 * { return that1.get2() - that2.get2(); }
					 */
